...
import {
  ArrowDownTrayIcon, ArrowLeftIcon, ArrowPathIcon, ArrowRightIcon, ArrowUpTrayIcon, Bars3Icon, BookOpenIcon, CalendarDaysIcon, ChartBarIcon, CheckCircleIcon, CheckIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, CircleStackIcon, CodeBracketIcon, Cog6ToothIcon, DocumentArrowDownIcon, DocumentCheckIcon, DocumentTextIcon, EyeIcon, EyeSlashIcon, FolderIcon, FolderOpenIcon, FunnelIcon, KeyIcon, ListBulletIcon, LockClosedIcon, MagnifyingGlassIcon, PaperAirplaneIcon, PencilIcon, PhotoIcon, PlusIcon, RectangleStackIcon, ShieldCheckIcon, SparklesIcon, Squares2X2Icon, TrashIcon, XCircleIcon, XMarkIcon,
} from '@heroicons/react/24/outline'

type Props = SVGProps<SVGSVGElement> & { size?: number | string }
const wrap = (Icon: ComponentType<SVGProps<SVGSVGElement>>) => ({ size = 20, ...props }: Props) => <Icon {...props} width={size} height={size} />
